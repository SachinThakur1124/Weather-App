  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between py-4">
        <img src={icon} alt="weatherIcon" className="w-20" />
        <p className="text-5xl">{`${temp.toFixed()}°`}</p>
        <div className="flex flex-col space-y-3 items-start mt-4 sm:mt-0">
      ...
      <div className="grid grid-cols-2 sm:flex sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-10 text-sm py-3">
